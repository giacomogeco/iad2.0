function [detections,EVENTS,dts,evts]=iad_detections2events2017(DT,L,txx,prs,cc,azz,slw,rs,Fp,shift)
...
if isempty(txx),
    ...
    disp('no events')
    EVENTS=[];
%     evts.data=vertcat(tti',ttf',D,Cm,Cd,Pmax,Pd,Am,azvar,Sm,Smax,Str,Fm,Fd,Rm,Rd,Prb,Sia,Siv,Amin,Amax);
    evts.data=vertcat(tti',D,Cm,Cd,Pmax,Pd,Am,azvar,Sm,Smax,Str,Fm,Fd,Rm,Rd,Prb,Sia,Siv,Amin,Amax);
    
    evts.legend={'1.Tempo inizio finestra';'2. Num. dets','3.Durata';'4.Coerenza media';...
	...
	'19.Vel. Stability index';'20.Az. start';'21.Az end'};
    return
...
events=vertcat(tti',ttf',D,Cm,Cd,Pmax,Pd,Am,azvar,Sm,Smax,Str,Fm,Fd,Rm,Rd,Prb,Sia,Siv,Amin,Amax);

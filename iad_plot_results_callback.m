...
%     ts=86400*(E.Ev_Ex.data(:,1)-T0);
    ...
    ['Baz: ',num2str(round(E.Ev_Ex.data(jex,8)*10)/10),' °N'], ...
    ['Baz_sd: ',num2str(round(E.Ev_Ex.data(jex,9)*10)/10),' °N'], ...
...
%     ts=86400*(E.Ev_Ex.data(:,1)-T0);
    ...
    ['Baz: ',num2str(round(E.Ev_Cav.data(jcav,8)*10)/10),' °N'],...
    ['Baz_sd: ',num2str(round(E.Ev_Cav.data(jcav,9)*10)/10),' °N'],...
...
%     ts=86400*(E.Ev_Ex.data(:,1)-T0);
    ...
    ['Baz: ',num2str(round(E.Ev_Nav.data(jnav,8)*10)/10),' °N'],...
    ['Baz_sd: ',num2str(round(E.Ev_Nav.data(jnav,9)*10)/10),' °N'],...

function D=iad_mcc_analysis_new(t,M,station,slh,working_dir,type)
...
%             % iserimento pdx parametro
            [pmx, pdx, cmax,az,azsd,va,vasd,RR,~,ffp,iex,cex,cdx]=iad_locator_planewave_new(pp,...
                maxl,trplts,fi,...
                xstzi,ystzi,minR,cps,bkzmaxstd,station,type);
...
D.legend={'1.time';'2.pressure';'3.backazimuth';'4.backazimuth_sd';'5.velocity';...
    '6.velocity_sd';'7.semblance';'8.frequency_peak';'9.consistency';'10.ExplosionIndex';...
    '11. Sensor s pressure (Pa)'; '12. Sensor s coherence (%)'};

D.status1=pd(~isnan(azz),:,:);
D.status2=cd(~isnan(azz),:,:);
